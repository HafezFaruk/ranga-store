...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product"> 
      ...
      <h6>Reting: ${product.rating.rate}
        <i class="fas fa-star reting-star"></i>
        <i class="fas fa-star reting-star"></i>
        <i class="fas fa-star reting-star"></i>
        <i class="fas fa-star-half-alt reting-star"></i>
        <i class="far fa-star reting-star"></i>
      </h6>
      <h6>Total-Review: <i class="fas fa-user-friends"></i> ${product.rating.count}</h6> 
